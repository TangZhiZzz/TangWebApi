...
namespace TangWebApi.Controllers
{
    ...
    public class EmailController : ControllerBase
    {
        ...
        [HttpPost("send")]
        public async Task<EmailSendResult> SendEmail([FromBody] SendEmailRequest request)
        {
        ...
        public async Task<EmailSendResult> SendTemplateEmail([FromBody] SendTemplateEmailRequest request)
        {
            if (!ModelState.IsValid)
            {
                throw new ArgumentException("请求参数无效");
